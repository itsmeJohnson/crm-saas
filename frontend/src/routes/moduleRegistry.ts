...
export const MODULES_REGISTRY: ModuleDefinition[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/calling', component: CallingPage, featureCode: 'CLICK_TO_CALL', sidebar: { name: 'Phone Calling', icon: PhoneCall } },
      { path: '/calling/reports', component: CallingReportsPage, featureCode: 'CLICK_TO_CALL' },
      { path: '/sms', component: SmsPage, featureCode: 'SMS_MESSAGING' },
      { path: '/sms/reports', component: SmsReportsPage, featureCode: 'SMS_MESSAGING' },
      { path: '/voice', component: VoicePage, featureCode: 'VOICE_BROADCAST', sidebar: { name: 'Voice Broadcast', icon: Megaphone } },
      { path: '/whatsapp', component: WhatsAppPage, featureCode: 'WHATSAPP_MESSAGING', sidebar: { name: 'WhatsApp Center', icon: MessageCircle } },
      { path: '/whatsapp/reports', component: WhatsAppReportsPage, featureCode: 'WHATSAPP_MESSAGING' },
      { path: '/whatsapp/settings', component: WhatsAppSettingsPage, featureCode: 'WHATSAPP_MESSAGING', roles: ['OrgAdmin'] },
      { path: '/email', component: EmailPage, featureCode: 'EMAIL_MESSAGING' },
      { path: '/email/reports', component: EmailReportsPage, featureCode: 'EMAIL_MESSAGING' },
      { path: '/email/settings', component: EmailSettingsPage, featureCode: 'EMAIL_MESSAGING', roles: ['OrgAdmin'] },
      { path: '/templates', component: TemplatesPage },
      { path: '/campaigns', component: CampaignsPage, featureCode: 'CAMPAIGN_MANAGEMENT' },
      { path: '/notifications', component: NotificationCenterPage },
      { path: '/communication-analytics', component: CommunicationAnalyticsPage, featureCode: 'CONVERSION_ANALYTICS' }
    ]
  },
  {
    key: 'billing',
  ...
  },
  {
    ...
    trial: true,
    routes: [
      // ── Convert tier: manager analytics, KPIs, goals ──
      { path: '/org-analytics', component: OrganizationAnalyticsPage, featureCode: 'MANAGER_DASHBOARD', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'Team Analytics', icon: BarChart3, group: 'Growth & Analytics' } },
      { path: '/executive-dashboard', component: ExecutiveDashboardPage, featureCode: 'MANAGER_DASHBOARD', roles: ['OrgAdmin', 'Manager'] },
      { path: '/kpi', component: KpiPage, featureCode: 'KPI_DASHBOARD', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'KPIs', icon: Gauge, group: 'Growth & Analytics' } },
      { path: '/okr', component: OkrPage, featureCode: 'TARGET_MANAGEMENT', roles: ['OrgAdmin', 'Manager'] },
      // ── Scale tier: advanced analytics + custom reports ──
      { path: '/report-builder', component: ReportBuilderPage, featureCode: 'CUSTOM_REPORTS', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'Report Builder', icon: BarChart3, group: 'Growth & Analytics' } },
      { path: '/scheduled-reports', component: ScheduledReportsPage, featureCode: 'CUSTOM_REPORTS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/sales-analytics', component: SalesAnalyticsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'Sales Analytics', icon: BarChart3, group: 'Growth & Analytics' } },
      { path: '/employee-analytics', component: EmployeeAnalyticsPage, featureCode: 'TEAM_MONITORING', roles: ['OrgAdmin', 'Manager'] },
      { path: '/financial-analytics', component: FinancialAnalyticsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/forecasting', component: ForecastingPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/visualizations', component: VisualizationPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/bi', component: BiExportPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/historical-analytics', component: HistoricalAnalyticsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/automation-analytics', component: AutomationAnalyticsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/predictive', component: PredictivePage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/compliance', component: CompliancePage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      // ── Scale tier: AI suite (call summaries, copilot, intelligence) ──
      { path: '/copilot', component: CopilotPage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'AI Copilot', icon: Activity, group: 'Growth & Analytics' } },
      { path: '/comm-intelligence', component: CommIntelligencePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'Call Summaries', icon: Activity, group: 'Growth & Analytics' } },
      { path: '/ai', component: AiPlatformPage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/lead-intelligence', component: LeadIntelligencePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/sales-intelligence', component: SalesIntelligencePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/knowledge', component: KnowledgeBasePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/document-intelligence', component: DocumentIntelligencePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/prediction-engine', component: PredictionEnginePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/prompt-studio', component: PromptStudioPage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/ai-governance', component: AiGovernancePage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/ai-analytics', component: AiAnalyticsPage, featureCode: 'AI_CALL_SUMMARY', roles: ['OrgAdmin', 'Manager'] },
      { path: '/recommendations', component: RecommendationsPage, featureCode: 'AI_FOLLOW_UP', roles: ['OrgAdmin', 'Manager'] },
      { path: '/workflow-assistant', component: WorkflowAssistantPage, featureCode: 'AI_FOLLOW_UP', roles: ['OrgAdmin', 'Manager'] },
      // ── Scale tier: API access + integrations ──
      { path: '/ai-developer', component: AiDeveloperPage, featureCode: 'API_ACCESS', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'API & Developer', icon: GitBranch, group: 'Growth & Analytics' } },
      { path: '/integrations', component: IntegrationsPage, featureCode: 'API_ACCESS', roles: ['OrgAdmin', 'Manager'], sidebar: { name: 'Integrations', icon: Webhook, group: 'Growth & Analytics' } },
      // ── Scale tier: automation & orchestration (advanced) ──
      { path: '/workflows', component: WorkflowsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/rules', component: RulesPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/automation', component: AutomationPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/events', component: EventsPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/queue', component: QueuePage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/scheduler', component: SchedulerPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/notification-automation', component: NotificationAutomationPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/sla', component: SLAPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] },
      { path: '/escalation', component: EscalationPage, featureCode: 'ADVANCED_ANALYTICS', roles: ['OrgAdmin', 'Manager'] }
    ]
  },
  {
    key: 'platform_core',
