      ...
      <div className="flex-1 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10.5 pr-4 py-2.5 bg-slate-900 border border-slate-800 rounded-xl text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:border-brand-500/50 focus:ring-2 focus:ring-brand-500/10 transition-all"
          />
        </div>
