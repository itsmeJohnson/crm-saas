...
EVENT_TYPES = {
    ...
    "approval": ["approval.requested", "approval.approved", "approval.rejected", "approval.escalated"],
...
TRIGGER_EVENT_MAP = {
    ...
    "approval_requested": "approval.requested", "approval_escalated": "approval.escalated",
