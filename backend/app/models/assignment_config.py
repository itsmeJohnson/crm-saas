...
from sqlalchemy import ForeignKey, Boolean, Enum, DateTime, JSON
...
class AssignmentConfig(Base):
    ...
    # Per-branch round-robin cursors: {branch_id: last_assigned_user_id}. Keeps
    # each branch's rotation independent of the org-wide cursor above.
    branch_cursors: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False, server_default="{}")
